 ...
 */
static inline size_t minval(size_t x, size_t y) { return (x <= y ? x : y); }
 ...
 * @param value - value to be set, passed as an int and converted to unsigned
 * char
 ...
 *        C string, and be large enough to contain the concatenated resulting
 * string
 ...
 * between 2 and 36, where 10 means decimal base, 16 hexadecimal, 8 octal, and 2
 * binary
 *
